        ...
        private void ClickButton(object p)
        {
            ...
            if (Password.Length == 4 || Password.Length > 4)
            {
               // MessageBox.Show(DateTime.Now.ToString());
                using (MySqlConnection connection = new MySqlConnection("datasource=192.168.0.101; port=3306;Initial Catalog='basakafe';username=kafe;password=1;CharSet=utf8;"))
                {
                    connection.Open();
                    string value = "";
